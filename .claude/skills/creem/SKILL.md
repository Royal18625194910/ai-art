# SKILL
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/SKILL
...
# 3d
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/3d
...
# Animations
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/animations
...
# Assets
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/assets
...
# Audio
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/audio
...
# Calculate metadata
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/calculate-metadata
...
# Can decode
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/can-decode
...
# Charts
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/charts
...
# Compositions
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/compositions
...
# Display captions
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/display-captions
...
# Extract frames
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/extract-frames
...
# Fonts
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/fonts
...
# Get audio duration
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/get-audio-duration
...
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/get-video-dimensions
...
# Get video duration
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/get-video-duration
...
# Gifs
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/gifs
...
# Images
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/images
...
# Import srt captions
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/import-srt-captions
...
# Lottie
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/lottie
...
# Measuring dom nodes
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/measuring-dom-nodes
...
# Measuring text
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/measuring-text
...
# Sequencing
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/sequencing
...
# Tailwind
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/tailwind
...
Tailwind must be installed and enabled first in a Remotion project - fetch  [https://www.remotion.dev/docs/tailwind](https://www.remotion.dev/docs/tailwind) using WebFetch for instructions.


# Text animations
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/text-animations
...
# Timing
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/timing

Interpolation curves in Remotion - linear, easing, spring animations

A simple linear interpolation is done using the `interpolate` function.

```ts title="Going from 0 to 1 over 100 frames" theme={null}
import {interpolate} from 'remotion';
...
```ts title="Going from 0 to 1 over 100 frames with extrapolation" theme={null}
const opacity = interpolate(frame, [0, 100], [0, 1], {
  extrapolateRight: 'clamp',
...
```ts title="Spring animation from 0 to 1 over 100 frames" theme={null}
...
# Transcribe captions
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/transcribe-captions
...
* `@remotion/install-whisper-cpp` - Transcribe locally on a server using Whisper.cpp. Fast and free, but requires server infrastructure.
  [https://remotion.dev/docs/install-whisper-cpp](https://remotion.dev/docs/install-whisper-cpp)
...
* `@remotion/whisper-web` - Transcribe in the browser using WebAssembly. No server needed and free, but slower due to WASM overhead.
  [https://remotion.dev/docs/whisper-web](https://remotion.dev/docs/whisper-web)
...
* `@remotion/openai-whisper` - Use OpenAI Whisper API for cloud-based transcription. Fast and no server needed, but requires payment.
  [https://remotion.dev/docs/openai-whisper/openai-whisper-api-to-captions](https://remotion.dev/docs/openai-whisper/openai-whisper-api-to-captions)


# Transitions
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/transitions
...
# Trimming
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/trimming
...
# Videos
Source: https://docs.creem.io/.cursor/skills/remotion-best-practices/rules/videos
...
# CLAUDE
Source: https://docs.creem.io/CLAUDE
...
* **Footer**: X (@creem\_io), LinkedIn socials
...
| Entity           | Key Fields                                                              |
| ---------------- | ----------------------------------------------------------------------- |
| **Product**      | id, name, price, currency, billing\_period, tax\_code                   |
| **Customer**     | id, email, name, country                                                |
| **Checkout**     | id, product\_id, customer info, success/return URLs                     |
| **Subscription** | id, status (active/paused/canceled/expired), current\_period\_start/end |
| **Transaction**  | id, type (charge/refund/chargeback), status, amount                     |
| **License**      | id, key, activation\_limit, status                                      |
| **Discount**     | id, code, type (percentage/fixed\_amount), duration                     |
...
# Creem CLI
Source: https://docs.creem.io/ai/for-agents/cli

Manage your entire Creem business from the terminal. Perfect for AI agents and automation workflows.
...
# Skill Files
Source: https://docs.creem.io/ai/for-agents/skill-files

Portable, machine-readable guides that give AI agents complete knowledge of Creem's payment platform.
...
# Store Monitoring
Source: https://docs.creem.io/ai/for-agents/store-monitoring

Let your AI agent watch your Creem store and notify you about sales, cancellations, and payment issues.
...
# Creem CLI
Source: https://docs.creem.io/ai/for-humans/cli
...
# Getting Started
Source: https://docs.creem.io/ai/for-humans/getting-started
...
# AI Integration
Source: https://docs.creem.io/ai/introduction
...
# Close an account
Source: https://docs.creem.io/api-reference/endpoint/close-credits-account
...
# Close an account
Source: https://docs.creem.io/api-reference/endpoint/close-customer-credits-account
...
Source: https://docs.creem.io/api-reference/endpoint/create-credits-account
...
# Create a customer
Source: https://docs.creem.io/api-reference/endpoint/create-customer
...
# Create a customer credits account
Source: https://docs.creem.io/api-reference/endpoint/create-customer-credits-account
...
# Credit an account
Source: https://docs.creem.io/api-reference/endpoint/credit-account
...
# Credit an account
Source: https://docs.creem.io/api-reference/endpoint/credit-customer-credits-account
...
# Debit an account
Source: https://docs.creem.io/api-reference/endpoint/debit-account
...
# Debit an account
Source: https://docs.creem.io/api-reference/endpoint/debit-customer-credits-account
...
# Freeze an account
Source: https://docs.creem.io/api-reference/endpoint/freeze-credits-account

post /v1/customer-credits/accounts/{id}/freeze
Freeze an account to prevent new transactions. The account remains readable.



# Freeze an account
Source: https://docs.creem.io/api-reference/endpoint/freeze-customer-credits-account
...
Source: https://docs.creem.io/api-reference/endpoint/get-credits-account
...
# Get account balance
Source: https://docs.creem.io/api-reference/endpoint/get-credits-account-balance
...
# Retrieve a customer credits account
Source: https://docs.creem.io/api-reference/endpoint/get-customer-credits-account
...
# Get account balance
Source: https://docs.creem.io/api-reference/endpoint/get-customer-credits-account-balance
...
Source: https://docs.creem.io/api-reference/endpoint/get-stats-summary
...
Source: https://docs.creem.io/api-reference/endpoint/list-credits-accounts
...
Source: https://docs.creem.io/api-reference/endpoint/list-credits-entries
...
# List account entries
Source: https://docs.creem.io/api-reference/endpoint/list-customer-credits-account-entries
...
# List customer credits accounts
Source: https://docs.creem.io/api-reference/endpoint/list-customer-credits-accounts
...
Source: https://docs.creem.io/api-reference/endpoint/list-customer-licenses
...
Source: https://docs.creem.io/api-reference/endpoint/list-customer-orders
...
Source: https://docs.creem.io/api-reference/endpoint/list-customer-subscriptions
...
Source: https://docs.creem.io/api-reference/endpoint/reverse-credits-transaction
...
# Reverse a transaction
Source: https://docs.creem.io/api-reference/endpoint/reverse-customer-credits-account-transaction
...
# Screen a prompt
Source: https://docs.creem.io/api-reference/endpoint/screen-prompt
...
Source: https://docs.creem.io/api-reference/endpoint/search-discounts
...
# List all subscriptions
Source: https://docs.creem.io/api-reference/endpoint/search-subscriptions
...
# Unfreeze an account
Source: https://docs.creem.io/api-reference/endpoint/unfreeze-credits-account
...
# Unfreeze an account
Source: https://docs.creem.io/api-reference/endpoint/unfreeze-customer-credits-account
...
# Update a customer
Source: https://docs.creem.io/api-reference/endpoint/update-customer
...
# Creem CLI
Source: https://docs.creem.io/code/cli
...
# Accounts
Source: https://docs.creem.io/features/customer-credits/accounts

Create and manage credit accounts for your customers.
...
# Customer Credits
Source: https://docs.creem.io/features/customer-credits/introduction

Give your customers a credit balance — points, gems, stars, or any unit. Build loyalty programs, prepaid wallets, and usage-based billing without building the infrastructure yourself.
...
# Transactions
Source: https://docs.creem.io/features/customer-credits/transactions

Add credits, remove credits, undo mistakes. Every change is tracked.
...
# Moderation
Source: https://docs.creem.io/features/moderation
...
Source: https://docs.creem.io/for-customers/cant-log-in-to-customer-portal

Troubleshoot magic link login issues and get access to manage your subscriptions.
...
# Dashboard Overview
Source: https://docs.creem.io/getting-started/dashboard-overview

Find your way around the Creem dashboard — where to find your Store ID, API keys, support settings, and more.
...
<Frame>
  <img alt="Creem Settings page showing Store ID at the top" />
</Frame>
...
<Frame>
  <img alt="Creem Developers page showing API Keys section with copy and reveal buttons" />
</Frame>
...
<Frame>
  <img alt="Creem Settings page showing Business Details section with Contact Email field" />
</Frame>
...
# Migrate to Creem
Source: https://docs.creem.io/getting-started/migrate
...
Source: https://docs.creem.io/guides/customer-credits-recipes
...
# FAQ
Source: https://docs.creem.io/guides/faq

Answers to the most common questions about using Creem.
...
Source: https://docs.creem.io/guides/sell-framer-templates-instant-remix-links
...
# Evendeals
Source: https://docs.creem.io/integrations/evendeals
...
<Frame>
  <img alt="Creem Balance page showing Payout Account tab with test mode notice" />
</Frame>
...
# Payout Accounts
Source: https://docs.creem.io/merchant-of-record/finance/payout-accounts

How to set up, change, and manage your payout accounts on Creem.
...
<Frame>
  <img alt="Creem Balance page showing balance summary and payout options" />
</Frame>
...
| :------------------------------------------------------------- | :-------------------: | :-------------------: |
| Albania                                                        | <Icon icon="check" /> |                       |
| Andorra                                                        | <Icon icon="check" /> |                       |
| Argentina                                                      | <Icon icon="check" /> |                       |
| Australia                                                      | <Icon icon="check" /> |                       |
| Austria                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Bangladesh                                                     | <Icon icon="check" /> |                       |
| Belgium                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Bosnia and Herzegovina                                         | <Icon icon="check" /> |                       |
| Brazil                                                         | <Icon icon="check" /> |                       |
| Bulgaria                                                       | <Icon icon="check" /> | <Icon icon="check" /> |
| Canada                                                         | <Icon icon="check" /> |                       |
| Cayman Islands                                                 | <Icon icon="check" /> |                       |
| Chile                                                          | <Icon icon="check" /> |                       |
| [China\*](/merchant-of-record/finance/payouts#transfer-limits) | <Icon icon="check" /> |                       |
| Colombia                                                       | <Icon icon="check" /> |                       |
| Costa Rica                                                     | <Icon icon="check" /> |                       |
| Croatia                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Cyprus                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Czech Republic                                                 | <Icon icon="check" /> | <Icon icon="check" /> |
| Denmark                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Dominican Republic                                             | <Icon icon="check" /> |                       |
| Egypt                                                          | <Icon icon="check" /> |                       |
| Estonia                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Finland                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| France                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Georgia                                                        | <Icon icon="check" /> |                       |
| Germany                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Gibraltar                                                      | <Icon icon="check" /> | <Icon icon="check" /> |
| Greece                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Guatemala                                                      | <Icon icon="check" /> |                       |
| Hong Kong                                                      | <Icon icon="check" /> |                       |
| Hungary                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Iceland                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| India                                                          | <Icon icon="check" /> |                       |
| Indonesia                                                      | <Icon icon="check" /> |                       |
| Ireland                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| Israel                                                         | <Icon icon="check" /> |                       |
| Italy                                                          | <Icon icon="check" /> | <Icon icon="check" /> |
| Japan                                                          | <Icon icon="check" /> |                       |
| Kenya                                                          | <Icon icon="check" /> |                       |
| Latvia                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Liechtenstein                                                  | <Icon icon="check" /> | <Icon icon="check" /> |
| Lithuania                                                      | <Icon icon="check" /> | <Icon icon="check" /> |
| Luxembourg                                                     | <Icon icon="check" /> | <Icon icon="check" /> |
| Malaysia                                                       | <Icon icon="check" /> |                       |
| Malta                                                          | <Icon icon="check" /> | <Icon icon="check" /> |
| Mexico                                                         | <Icon icon="check" /> |                       |
| Moldova                                                        | <Icon icon="check" /> |                       |
| Monaco                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Montenegro                                                     | <Icon icon="check" /> |                       |
| Morocco                                                        | <Icon icon="check" /> |                       |
| Nepal                                                          | <Icon icon="check" /> |                       |
| Netherlands                                                    | <Icon icon="check" /> | <Icon icon="check" /> |
| New Zealand                                                    | <Icon icon="check" /> |                       |
| Nigeria                                                        | <Icon icon="check" /> |                       |
| North Macedonia                                                | <Icon icon="check" /> |                       |
| Norway                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Pakistan                                                       | <Icon icon="check" /> |                       |
| Peru                                                           | <Icon icon="check" /> |                       |
| Philippines                                                    | <Icon icon="check" /> |                       |
| Poland                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Portugal                                                       | <Icon icon="check" /> | <Icon icon="check" /> |
| Romania                                                        | <Icon icon="check" /> | <Icon icon="check" /> |
| San Marino                                                     | <Icon icon="check" /> | <Icon icon="check" /> |
| Serbia                                                         | <Icon icon="check" /> |                       |
| Singapore                                                      | <Icon icon="check" /> |                       |
| Slovakia                                                       | <Icon icon="check" /> | <Icon icon="check" /> |
| Slovenia                                                       | <Icon icon="check" /> | <Icon icon="check" /> |
| South Africa                                                   | <Icon icon="check" /> |                       |
| South Korea                                                    | <Icon icon="check" /> |                       |
| Spain                                                          | <Icon icon="check" /> | <Icon icon="check" /> |
| Sri Lanka                                                      | <Icon icon="check" /> |                       |
| Sweden                                                         | <Icon icon="check" /> | <Icon icon="check" /> |
| Switzerland                                                    | <Icon icon="check" /> | <Icon icon="check" /> |
| Taiwan                                                         | <Icon icon="check" /> |                       |
| Tanzania                                                       | <Icon icon="check" /> |                       |
| Thailand                                                       | <Icon icon="check" /> |                       |
| Turkey                                                         | <Icon icon="check" /> |                       |
| Ukraine                                                        | <Icon icon="check" /> |                       |
| United Arab Emirates                                           | <Icon icon="check" /> |                       |
| United Kingdom                                                 | <Icon icon="check" /> | <Icon icon="check" /> |
| United States of America                                       | <Icon icon="check" /> |                       |
| Uruguay                                                        | <Icon icon="check" /> |                       |
| Vietnam                                                        | <Icon icon="check" /> |                       |
| Zambia                                                         | <Icon icon="check" /> |                       |
